...
public:    	
	...
	static vector<double> QualitativeSequential(double t, double e, double r, double s, double b, double c, double h, double &ll, double &hue);//by Henan
	static vector<double> QualitativeSequential_LCH(double t, double e, double r, double s, double b, double c, double h);
	//static vector<double> QualitativeSequential2(double t, double e, double r, double s, double b, double c, double h, double &ll, double &hue);//by Henan
	static vector<double> QualitativeSequential2(double t, double e, double r, double s, double b, double c, double h);
