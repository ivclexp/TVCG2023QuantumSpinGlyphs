...
vector<double> CIEColor2::QualitativeSequential(double t, double e, double r, double s, double b, double c, double h, double &ll, double &hue)
{
	vector<double> pbright(3,0);
	vector<double> luv = RGBtoCIEluv(1,1,0);
	pbright[0] = luv[0];
	...
	//cerr<<t<<" "<<Pseg[0]<<" "<<Pseg[1]<<" "<<Pseg[2]<<endl;
...
vector<double> CIEColor2::QualitativeSequential_LCH(double t, double e, double r, double s, double b, double c, double h)
{
	vector<double> pbright(3,0);
	vector<double> luv = RGBtoCIEluv(1,1,0);
	pbright[0] = luv[0];
...
/*vector<double> CIEColor2::QualitativeSequential2(double t, double e, double r, double s, double b, double c, double h, double &ll, double &hue)
{
	vector<double> pbright(3,0);
	vector<double> luv = RGBtoCIEluv(1,1,0);
	pbright[0] = luv[0];
	...
	double tmpt;// = GetSmallt(ll,s,0.,1);
	double A = log10((125-ll)/125) / log10(0.2);
	tmpt = (A - (1-1)*0)/1;
	Pseg = SinglehueSequential(tmpt, s, 0, 1, Pseg[2]);
...
vector<double> CIEColor2::QualitativeSequential2(double t, double e, double r, double s, double b, double c, double h)
{
	vector<double> pbright(3,0);
	vector<double> luv = RGBtoCIEluv(1,1,0);
	pbright[0] = luv[0];
...
double CIEColor2:: GetSmallt(double l, double s, double b, double c)
{

	double t;
	double A = log10((125-l)/125) / log10(0.2);
	t = (A - (1-c)*b)/c;
